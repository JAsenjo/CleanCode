 ...
 */
public abstract class AbstractFragment<T, S, PresenterType extends PresenterOperations<T>> extends Fragment implements ViewOperations {

    /**
     *
     */
    private final StateMaintainer mStateMaintainer = new StateMaintainer(getFragmentManager(), getClass().getSimpleName() + "_retainer");
     ...
     * @param view
     */
    public void onCreate(final Class<PresenterType> type, final T view) {
        try {
            if (mStateMaintainer.isFirstTime(getFragmentManager())) {
    ...
    public void showToast(final String message, final int duration) {
        Toast.makeText(getViewContext(), message, duration).show();
    }
    ...
    public void showAlertDialog(final String message, final int type) {
        ...
        this.mAlertDialog = new android.app.AlertDialog.Builder(getViewContext())
                .setTitle(title)
                .setMessage(message)
    ...
    public void showProgress() {
        ...
        this.mProgressDialog = new ProgressDialog(getViewContext());
    ...
    public Context getApplicationContext() {
        return getViewContext().getApplicationContext();
    }
     ...
     */
    private void initialize(final Class<PresenterType> type, final T view) throws java.lang.InstantiationException, IllegalAccessException {
     ...
     * @throws IllegalAccessException
     */
    private void reinitialize(final Class<PresenterType> type, final T view) throws java.lang.InstantiationException, IllegalAccessException {
